...
Was sind die **zwei Forschungsfragen** genau, die die Autor\*innen versuchen zu beantworten?
...
1. Between-Subjects-Design vs. Within-Subjects-Design: welches Design verwendet diese Studie? Wieso?
2. Eye-Tracking (online) und forced-choice Pointing (offline): Wie funktionieren diese experimentellen Paradigma?
3. Wieso werden beide Paradigma verwendet?
4. Wie laufen die Experimente ab?
...
- Im Anschluss stellt ihr eure eigene Studie mit Hilfe von einem Handout, kleinen Poster oder wenigen (!) Folien vor
- Fragen & Diskussion
...
- Unterschiede zwischen Zielsprache und der Ausgangssprache (nur bezüglich der relevanten Eigenschaften)
- Methode: wählt ihr die gleiche oder eine andere?
...
- falls mehrere Experimente im Artikel durchgeführt werden, müsst ihr nur eines davon in eure Sprache übertragen

[**wichtig**: Ihr müsst **keine** perfekte, durchführbare Studie erstellen.]{style="color: #9d1152ea; "}

Das Hauptziel dieser Studienleistung ist die vertiefte Auseinandersetzung mit dem Aufbau von Experimenten und dem Einfluss von unterschiedlichen Sprachen auf die Sprachverarbeitung und den Spracherwerb. Ebenso dient die Studienleistung als Grundlage für die Diskussion in der Sitzung. 
...
- Motivation:
  - flexiblere Worstellung im Russischen als im Englischen
- Forschungsfrage: Weisen russischsprechende Kinder first-NP-as-agent Bias in ihrer Satzverarbeitung auf?
- Unterschied zur Originalstudie: Manipulation von Reihenfolge der Semantischen Rollen durch Worstellung, nicht durch Diathese
- Methode:
...
[@timberlake2004reference]{style="font-size: 70%;"}
...
| PVA | nicht ambig | 2-Jährige: mehr Blicke zu AVP vor dem Verb, bei 2. NP: keine Präferenz; 3-jährige: keine Präferenz vor dem Verb, beim 2. NP mehr Blicke zu PVA | 2-Jährige: hohe Fehlerquote (niedriger als bei PVA+ambig), 3-jährige: oberhalb des Zufallswert |
