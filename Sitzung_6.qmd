...
![](images/Abbot_Smith_1.png){width=2000}
...
![](images/Abbot_Smith_3.png){width=1000}

### Diskussion

- Wie stehen die Ergebnisse von @abbot-smith2017 im Vergleich mit @sauppe2022?
- Würden wir die gleichen Ergebnisse bei Kindern, die eine andere Sprache lernen, sehen?
- Was findet ihr besonders überzeugend oder eher weniger überzeugend an der Studie (im Bezug auf die Methode, Resultate und Interpretation deren)?
...
- Ihr wählt einen Artikel 
    - entweder einen aus der Liste oder ihr sucht selber einen (Inhalt muss den Themen, die wir hier besprochen haben, entsprechen)
...
- Wie unterscheidet sich die Zielsprache von der Originalsprache in den relevanten Eigenschaften?
- Würdet ihr die gleiche Methode anwenden? 
- Was ist eure Hypothese/was sind eure Erwartungen basierend auf ...
    - ... den Eigenschaften der Sprache? (**Grammatik**)
    - ... Häufigkeiten unterschiedlicher Eigenschaften/Strukturen in der Sprache? (**Sprachgebrauch**, wenn möglich)
- Zeigt eure Konditionen anhand von einem **Item** auf (keine Liste von allen Stimuli erforderlich)
...
In an experiment examining surprisal effect, sentence length might be a confounding variable that is
responsible for the relation between surprisal and reaction time (RT)
...
- Worstellung: flexibel, alle sechs Worstellungen sind erlaubt, Worstellung hängt von Informationsstruktur ab @bailyin
- Kasussystem: 
...
- Stimuli:
    ...
    - Verben: prototypische, transitive Verben 
